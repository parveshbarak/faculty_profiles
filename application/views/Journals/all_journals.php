                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $conf->PublType ?></td>
                            <td><?php echo $conf->Authors ?></td>
                            <td><?php echo $conf->JournalNO ?></td>
                            <td><a href="<?php echo base_url(); ?>index.php/google_login/edit_journals/<?php echo $conf->id ?>">Edit </a> </td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
